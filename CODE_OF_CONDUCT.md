...
reported privately to the verified maintainer contact
[@choco_chip2m on X](https://x.com/choco_chip2m). Security vulnerabilities
should instead be reported through the private process in [SECURITY.md](SECURITY.md).
...
3. Temporary Ban: A temporary ban from project interaction for a defined period.
4. Permanent Ban: A permanent ban from project interaction.
